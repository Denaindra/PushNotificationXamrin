...
extern void *mono_aot_module_PushNotificationXamrin_iOS_info;
...
{
	mono_aot_register_module (mono_aot_module_PushNotificationXamrin_iOS_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "PushNotificationXamrin.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
